        ...
        "responses": [
    ...
    },
            {
                ...
                "patterns": [
                  ...
                  "Can you provide details about {data['company_name']}?",
            ...
            },
            {
                ...
                "responses": [
                    f"We offer {data['products_services']}.",
                    f"Our main services include {data['products_services']}.",
                    f"We provide the following: {data['products_services']}.",
                    f"Our company specializes in {data['products_services']}.",
                    f"Here are our services: {data['products_services']}.",
                    f"You can get {data['products_services']} from us.",
                    f"Our offerings include {data['products_services']}.",
                    f"We deliver {data['products_services']}.",
                    f"{data['products_services']} are the core of our business.",
                    f"Looking for {data['products_services']}? We’ve got you covered!"
                ]
            },
            {
                    "tag": "thanks",
